...
ATSglobal(ats_sum_type, ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__CHAINcons_0) ;
ATSglobal(ats_sum_type, ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__CHAINnil_1) ;
...
ATSglobaldec()
ats_size_type
ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_size (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_size_type, tmp0) ;
ATSlocal (ats_ptr_type, tmp1) ;

__ats_lab_ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_size:
...
return (tmp0) ;
} /* end of [ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_size] */
...
ATSglobaldec()
ats_size_type
ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_total (ats_ptr_type arg0) {
/* local vardec */
ATSlocal (ats_size_type, tmp2) ;
ATSlocal (ats_ptr_type, tmp3) ;

__ats_lab_ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_total:
...
return (tmp2) ;
} /* end of [ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_total] */
...
ATSglobaldec()
ats_ptr_type
ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_make (ats_clo_ref_type arg0, ats_clo_ref_type arg1) {
/* local vardec */
ATSlocal (ats_ptr_type, tmp4) ;

__ats_lab_ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_make:
tmp4 = atslib_hashtbl_make_hint__chain (arg0, arg1, 0) ;
return (tmp4) ;
} /* end of [ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__hashtbl_make] */
...
static int ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__staload_flag = 0 ;
if (ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__staload_flag) return ;
ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__staload_flag = 1 ;

// ATS_2d0_2e2_2e11_2libats_2SATS_2hashtable_chain_2esats__staload () ;

// ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__CHAINcons_0.tag = 0 ;
ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__CHAINnil_1.tag = 1 ;
return ;
} /* staload function */
...
// extern ats_int_type ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__dynload_flag ;

ats_void_type
ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__dynload () {
// ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__dynload_flag = 1 ;
ATS_2d0_2e2_2e11_2libats_2DATS_2hashtable_chain_2edats__staload () ;
