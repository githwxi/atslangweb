...
** The starting compilation time is: 2014-10-6:  0h:50m
**
*/
...
{
// COMMENT_line
return ace.edit("thePage2RBody1").getSession().getValue();
// COMMENT_line
} // COMMENT_line
// COMMENT_line
/* ATSextcode_end() */
  ...
  (reply)
{
  ...
  if(comparr[0]===0)
  {
    alert("Patsoptaas: [patsopt-tcats] passed!");
  }
  if(comparr[0] > 0)
  {
    alert("Patsoptaas: [patsopt-tcats] failed!");
  }
  return;
}
// COMMENT_line
  ...
  (reply)
{
  ...
  if(comparr[0] > 0)
  {
    alert("Patsoptaas: [patsopt-ccats] failed!");
  }
  return;
}
// COMMENT_line
  ...
  (reply)
{
  ...
  if(comparr[0] > 0)
  {
    alert("Patsoptaas: [patsopt-atscc2js] failed!");
  }
  return;
}
// COMMENT_line
...
//
  ...
  tmp59 = Patsoptaas_thePatsopt_source_get();
