...
** The starting compilation time is: 2014-9-20: 23h:40m
**
*/
...
//
  ...
  tmp50 = Home_repeat_f0f1_getval();
  atslangweb__patsopt_atscc2js_rpc__2__2(tmp50);
  return/*_void*/;
} // end-of-function
...
//
  ...
  ats2js_Ajax_XMLHttpRequest_open(tmp4__2, "POST", "SERVER/mycode/atslangweb__patsopt_atscc2js_1_.php", true);
...
//
  ...
  if(tmp7__2) {
    ...
    atslangweb__patsopt_atscc2js_rpc__reply__15__1(tmp8__2);
  } else {
    // ATSINSmove_void
  } // endif
  return/*_void*/;
