...
** The starting compilation time is: 2014-9-22:  0h: 1m
**
*/
...
{
  document.getElementById("hello_button").value = name; return
}
// COMMENT_line
function
Home_hello_reply(reply)
{
  ...
  Home_hello_button_set("Try-it-yourself");
  return;
}
// COMMENT_line
/* ATSextcode_end() */
...
//
  ...
  tmp29__1 = ats2js_Ajax_XMLHttpRequest_new();
  ats2js_Ajax_XMLHttpRequest_set_onreadystatechange(tmp29__1, atslangweb__patsfun_10__10__1__closurerize(tmp29__1));
  ats2js_Ajax_XMLHttpRequest_open(tmp29__1, "POST", "SERVER/mycode/atslangweb__patsopt_tcats_1_.php", true);
  ats2js_Ajax_XMLHttpRequest_setRequestHeader(tmp29__1, "Content-type", "application/x-www-form-urlencoded");
  tmp37__1 = ats2jspre_encodeURIComponent(arg0);
  tmp36__1 = ats2jspre_string_append("mycode=", tmp37__1);
  ats2js_Ajax_XMLHttpRequest_send_1(tmp29__1, tmp36__1);
  return/*_void*/;
} // end-of-function
...
//
  ...
  tmp32__1 = ats2js_Ajax_XMLHttpRequest_is_ready_okay(env0);
  if(tmp32__1) {
    tmp33__1 = ats2js_Ajax_XMLHttpRequest_get_responseText(env0);
    atslangweb__patsopt_tcats_rpc__reply__8__1(tmp33__1);
  } else {
    // ATSINSmove_void
  } // endif
  return/*_void*/;
...
//
  ...
  tmp51 = Home_repeat_f0f1_getval();
  atslangweb__patsopt_atscc2js_rpc__2__2(tmp51);
  return/*_void*/;
} // end-of-function
