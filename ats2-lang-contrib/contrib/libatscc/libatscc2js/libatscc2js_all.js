...
** The starting compilation time is: 2016-10-16: 22h:12m
**
*/
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmpret119 = ats2jspre_ListSubscriptExn_throw();
      break;
      // ATSbranchseq_end
    } // end-of-switch
    if (tmplab_js === 0) break;
  ...
  while(true) {
    ...
    while(true) {
      ...
      switch(tmplab) {
        ...
        if(tmp128) {
          tmp129 = ats2jspre_sub_int1_int1(arg1, 1);
          // ATStailcalseq_beg
          apy0 = tmp127;
          apy1 = tmp129;
          arg0 = apy0;
    ...
    // ATScaseofseq_end
    if (funlab_js > 0) continue; else return tmpret125;
  } // endwhile-fun
} // end-of-function
...
//
  ...
  tmpret130 = _ats2jspre_ML_list0_aux_68(arg2, arg0, arg1);
  return tmpret130;
} // end-of-function


function
_ats2jspre_ML_list0_aux_68(env0, arg0, arg1)
{
//
// knd = 0
  var tmpret131
...
//
  ...
  tmp132 = ats2jspre_gt_int1_int1(arg1, 0);
  if(tmp132) {
    // ATScaseofseq_beg
    tmplab_js = 1;
    while(true) {
      ...
      switch(tmplab) {
        ...
        tmp135 = _ats2jspre_ML_list0_aux_68(env0, tmp134, tmp136);
        tmpret131 = [tmp133, tmp135];
        break;
        // ATSbranchseq_end
      } // end-of-switch
      if (tmplab_js === 0) break;
...
//
  ...
  tmpret137 = _ats2jspre_ML_list0_aux_70(arg0, arg1);
  return tmpret137;
} // end-of-function


function
_ats2jspre_ML_list0_aux_70(arg0, arg1)
{
//
// knd = 0
  var tmpret138
...
//
  ...
  while(true) {
    ...
    switch(tmplab) {
      ...
      tmp139 = arg0[0];
      tmp140 = arg0[1];
      tmp141 = ats2jspre_gt_int1_int1(arg1, 0);
      if(tmp141) {
        tmp143 = ats2jspre_sub_int1_int1(arg1, 1);
        tmp142 = _ats2jspre_ML_list0_aux_70(tmp140, tmp143);
        tmpret138 = [tmp139, tmp142];
      } else {
        tmpret138 = tmp140;
      } // endif
      break;
